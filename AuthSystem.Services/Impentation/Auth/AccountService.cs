...
namespace AuthSystem.Services.Impentation.Auth;
...
public class AccountService : IAccountService
{
    ...
    public void ResendVerifcationToken(string email, string origin)
    {
        var account = _context.Accounts.SingleOrDefault(x => x.Email == email);

        if (account == null)
            throw new AppException("Account not registered");
